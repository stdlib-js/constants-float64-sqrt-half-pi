...
```javascript
SQRT_HALF_PI = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-sqrt-half-pi@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-sqrt-half-pi@umd/bundle.js"></script>
```
